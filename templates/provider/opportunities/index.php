...
<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-4 mb-4">
        <form method="get" action="<?= APP_URL ?>/provider/opportunities" class="flex flex-wrap gap-3 items-end">
            <div>
            ...
            <a href="<?= APP_URL ?>/provider/opportunities" class="text-xs text-slate-400 hover:text-slate-600 self-end mb-2">Limpar</a>
            <?php endif; ?>
        </form>
    </div>
